...
1.  *Data_wrangling.R*
    ...
    -   Produces supplementary figure S1, figure S6
    -   Exports: "event_edited2.csv", "Net_summary.csv" (supplementary table S1)
...
5.  *Distribution_raincloud_plot.R*

    -   Produces figure S2

6.  *Presence-absence.qgz* (for use in QGIS)

    -   Produces supplementary figure S3
    -   Prerequisites: [Quantarctica3](https://www.npolar.no/quantarctica/)
...
7.  *Model_comparison.R*
    ...
    -   Produces supplementary figure S7
    -   Exports: "Model_comparison.csv" (supplementary table S2)

8.  *DVM_analysis.R*

    -   Runs the species-specific GAMs and all-species GAM
    -   Produces figure 2, figure 3, figure 4
    -   Exports: "DVM_pattern.csv" (table 1), "GAM_result.csv" (supplementary table S6)
...
9.  *Total_biomass_analysis.R*
    ...
    -   Exports: "Total_biomass_estimate.csv" (table 2), "Length_model_summary.csv" (supplementary table S4), "Size_summary.csv" (supplementary table S5)
...
10. *Fish_size_differences.R*
    ...
    -   Produces supplementary figure S4, figure S5, figure S8

11. *DVM_analysis_light.R*

    -   Sensitivity analysis on the effect of depth (light attenuation) on net avoidance
    -   Produces supplementary figure S9
